...
class ProfileApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: ChangeNotifierProvider<LikeCount>(
            create: (context) => LikeCount(), child: Home()));
  }
}
              ...
              child: Column(children: [
                Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: () {
                        Provider.of<LikeCount>(context, listen: false)
                            .incrementLikeCount();
                        print(Provider.of<LikeCount>(context).likeCount);
                      },
                      child: Icon(Icons.favorite),
                    ),
                    Text(
                      '${Provider.of<LikeCount>(context).likeCount} likes',
